...
# no huffman to layout
# delete not immediately available
...
def update(decision):
	...
	#print "chosen:", chosen
		...
		#print "in update, chosen after remove del", chosen
