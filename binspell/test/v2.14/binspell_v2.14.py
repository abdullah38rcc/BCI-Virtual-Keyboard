...
def resetConsts(typed):
	...
	#bg._print(gv._currCondTree)		#stub
...
def shuffle(chosen,Nchosen,inTextBx):
	global gv
...
def update(decision,inTextBx):
	...
	return shuffle(chosen,Nchosen,inTextBx)	#shuffle symbols
...
def tryOutput(symb):
	...
	while not inTxtBox:
		#print "in tryoutput: not printed yet"
